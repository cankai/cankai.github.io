 ...
 ************************************************************************/
#include "DevLevt.h"
IMPL_LOGGER(DevLevt, logger);

DevLevt::DevLevt(const string& cmd_type):HTTPRequest(cmd_type)
{
    ...
    tb_name = g_config_reader->get_string("dev_levt.table");
 }
 DevLevt::~DevLevt()
 {
    LOG4CPLUS_DEBUG(logger, __FUNCTION__ << "(" << this << ")");
 ...
 *************************************************************************/
int DevLevt::handle(json::Value& jsPara)
{
    return 0;
}
